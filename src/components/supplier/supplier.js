...
function Supplier({ supplierData, onUpdateGudang, receiveStock, onUpdateTransactionStatus }) {
  ...
  const handleAddSupplier = (e) => {
    ...
    onUpdateTransactionStatus(newSupplier.itemName, 'valid');
  ...
  return (
    <div>
      <div className="supplier-list-container p-4 bg-gray-100 mt-20 rounded-lg shadow-md pr-10 pl-10">
        <h2 className="text-2xl font-bold mb-4 text-gray-700">Supplier Request</h2>
